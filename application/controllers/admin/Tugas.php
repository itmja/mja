...
class Tugas extends MY_Controller {
	...
	public function add_exit() {
		...
		$add =  $this->db->query("INSERT INTO xin_tugas (user_id,company_id,date,ket)VALUES('$user_id','$company_id','$date','$ket')");
