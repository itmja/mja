      ...
      <div class="row no-gutters row-bordered h-100">
        ...
        <div class="d-flex col-sm-6 col-md-3 col-lg-3 align-items-center">
          ...
          <?php $proj = $this->Xin_model->get_all_projects();
            ...
            ?>
          <a href="javascript:void(0)" class="card-body media align-items-center text-body"> <i class="ion ion-logo-buffer display-4 d-block text-primary"></i> <span class="media-body d-block ml-3"> <span class="text-big font-weight-bolder"><?php echo $this->db->query("SELECT * FROM xin_companies ")->num_rows();?></span><br>
          <small class="text-muted">Unit</small> </span> </a> </div>
          <?php  } ?>
        ...
        <div class="d-flex col-sm-6 col-md-3 col-lg-3 align-items-center">
          ...
          <?php $task_all = $this->Xin_model->get_all_tasks();
            ...
            ?>
          <a href="javascript:void(0)" class="card-body media align-items-center text-body"> <i class="lnr lnr-database display-4 d-block text-primary"></i> <span class="media-body d-block ml-3"> <span class="text-big font-weight-bolder"><?php echo $this->db->query("SELECT * FROM xin_tugas ")->num_rows();?></span><br>
          <small class="text-muted">Surat Tugas</small> </span> </a> </div>
          <?php  } ?>
      </div>
    </div>
    <!-- / Stats + Links --> 
              ...
              <table class="table mb-0 table-dashboard">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url('admin/employees/unit/'.$ecompany->company_id);?>"><?php echo htmlspecialchars_decode($ecompany->name);?> (<?php echo $cquery1->num_rows();?>)</a></td>
                  </tr>
                  <?php $ck++; } ?>
                  <?php  } ?>
                </tbody>
