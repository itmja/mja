...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/bpjs/bpjs_keluar');?>" data-link-data="<?php echo site_url('admin/bpjs/bpjs_aktif');?>" class="mb-3 nav-link hrsale-link"> <span class="sw-done-icon fas fa-user-friends"></span> <span class="sw-icon fas fa-user-friends"></span> BPJS KELUAR
      <div class="text-muted small"><?php echo $this->lang->line('xin_set_up');?> Atur BPJS</div>
      </a> </li>
...
<?php if($user_info[0]->user_role_id==1){ ?>
    ...
    <?php echo form_open('admin/bpjs/bpjs_keluar');?>
...
<div class="row m-b-1 <?php echo $get_animate;?>">
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong>Data BPJS Yang Harus Dikeluarkan</strong></span> </div>
