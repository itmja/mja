...
class Job_post_model extends CI_Model {
	...
	public function get_jobs() {
	  return $this->db2->query("SELECT *,kategori_job.nama_job FROM new_job INNER JOIN kategori_job ON kategori_job.id_job = new_job.id_kjob");
	}
	function total_lamar() {
		return $this->db2->get('lamar')->num_rows();
	  }
	  function kat_job() {
		return $this->db2->get('kategori_job');
	  }
	// get jobs/cms pages
	...
	public function get_jobs_candidates() {
	  return $this->db2->get("biodata_lo");
	}
