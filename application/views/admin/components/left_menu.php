...
<ul class="sidenav-inner py-1">
  ...
  <li class="<?php if(!empty($arr_mod['stff_open']))echo $arr_mod['stff_open'];?> sidenav-item"> <a href="#" class="sidenav-link sidenav-toggle"> <i class="sidenav-icon fas fa-user-friends"></i>
    ...
    <ul class="sidenav-menu">
      ...
      <li class="sidenav-item <?php if(!empty($arr_mod['pkwt']))echo $arr_mod['pkwt'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/pkwt/');?>" > PKWT </a> </li>
      <li class="sidenav-item <?php if(!empty($arr_mod['bpjs']))echo $arr_mod['bpjs'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/bpjs/');?>" > BPJS </a> </li>
      <?php } ?>
      <?php if($user_info[0]->user_role_id==1){?>
  ...
  <li class="sidenav-item <?php if(!empty($arr_mod['pay_generate_active']))echo $arr_mod['pay_generate_active'];?>"> <a href="#" class="sidenav-link"> <i class="sidenav-icon fa fa-calculator"></i>
  ...
  <li class="<?php if(!empty($arr_mod['emp_open']))echo $arr_mod['emp_open'];?> sidenav-item"> <a href="#" class="sidenav-link sidenav-toggle"> <i class="sidenav-icon ion ion-ios-globe"></i>
    ...
    <ul class="sidenav-menu">
      ...
      <li class="<?php if(!empty($arr_mod['tugas']))echo $arr_mod['tugas'];?> sidenav-item"><a href="<?php echo site_url('admin/tugas');?>" class="sidenav-link"> Tugas Staff</a></li>
